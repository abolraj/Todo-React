    ...
    if(isWin)
        return (
            <>
                ...
                <div className={"h3 p-4 rounded-5 d-flex align-items-start win-alert alert alert-success alert-dismissible position-fixed col-9 col-sm-6 fade " + (isWin ? 'show' : '')} role="alert" data-bs-theme="dark">
                    <button onClick={_onClose.bind(this)} className="btn btn-close m-1" data-bs-dismiss="alert" aria-label="Close">
                        
                    </button>
                    <button onClick={_onPlayAgain.bind(this)} className="btn btn-outline-primary position-absolute col-12 top-100 mt-2 start-0 p-2 rounded-5 shadow-none" data-bs-dismiss="alert">
